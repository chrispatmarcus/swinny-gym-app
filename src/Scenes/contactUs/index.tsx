            ...
            <motion.div  onViewportEnter={()=>setSelectedPage(SelectedPage.OurClasses)}>
                ...
                <motion.div
                 ...
                 >
                    ...
                    <p className="my-5">
                        sjdkjsdkjskd sjdksdkjskd sdjskjdsk jdksjdk djksjdks djksjdk jdskjd djskjdkas jdksjdk jdskjdks
                        djskadk sjdkjdks sjdksjdk sdjksjdks sjdskjdks sjdksjdk sjksjdk.jdsjdksj sdjsjd.nulladsd
                        akmdksksjdksjdk sdksjdks kdjskdjsk skdjskjdks skdksjdks sdjskdjks sdjksjdksj ksjdksjdk.
                    </p>
                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    ...
                    >
                        ...
                        target="_blank"
                        onSubmit={onSubmit}
                        action="https://formsubmit.co/wanchinchrispat401@email.com" 
                        method="POST" 
                        >
                            <input 
